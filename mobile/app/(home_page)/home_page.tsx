          ...
          <View style={[styles.frameGroup, styles.viewFlexBox]}>
            {estoque.length > 0 ? (
                estoque.slice(0, 5).map((item, index) => {
                  ...
                  // Formata fator RH: 'p' -> '+', 'n' -> '-'
                  const fator = (item.fatorrh || '').toString().toLowerCase();
                  const fatorSymbol = fator === 'p' ? '+' : fator === 'n' ? '-' : item.fatorrh;
                  return (
                    <View key={index} style={styles.frameBorder}>
                      <View style={[styles.vectorParent, styles.vectorFlexBox]}>
                        ...
                        <Text style={[styles.a, styles.aFlexBox]}>{item.grupoabo}{fatorSymbol}</Text>
                      </View>
                      <Line />
                ...
                <View style={styles.statTopRow}>
                  ...
                  <View>
                    ...
                    <View style={styles.progressBar}>
                      <View style={[styles.progressFill, { width: `${Math.round(rankingProgress * 100)}%` }]} />
                    </View>
                  </View>
                </View>
                <View style={styles.statFooterSmall}>
